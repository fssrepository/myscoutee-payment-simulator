...
<body><main><img class="provider-logo" src="/simulator-ui/barion.svg" alt="Barion"><h1>Was this you?</h1><p class="warning">Simulated bank confirmation. MyScoutee does not control whether this challenge is required.</p>
